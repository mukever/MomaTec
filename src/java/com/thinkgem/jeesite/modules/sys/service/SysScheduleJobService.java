...
public class SysScheduleJobService extends CrudService<SysScheduleJobDao, SysScheduleJob> {
	...
	public void addJob(SysScheduleJob job) throws SchedulerException {
		...
		if (null == trigger) {
			...
			Class<? extends Job> clazz = SysScheduleJob.CONCURRENT_IS.equals(job.getIsConcurrent()) ? QuartzJobFactory.class : QuartzJobFactoryDisallowConcurrentExecution.class;
